...
export const MenuSettings = () => {
  ...
  return (
    <div >
      <button className="bottom-7.5 right-7.5 text-xl z-990 shadow-soft-lg rounded-circle fixed cursor-pointer bg-white px-4 py-2 text-slate-700" onClick={handleActive}>
        <i className="py-2 pointer-events-none fa fa-cog" ></i>
      </button>
      {
        active && (
          <div className="z-sticky shadow-soft-3xl w-90 ease-soft fixed top-0 left-auto flex  h-[50%] min-w-0 flex-col break-words rounded-none border-0 bg-white bg-clip-border px-2.5 duration-200 right-0">
            ...
            <div className="px-6 pt-4 pb-0 mb-0 bg-white border-b-0 rounded-t-2xl">
              ...
              <div className="float-right mt-6">
                <button className="inline-block p-0 mb-4 text-xs font-bold text-center uppercase align-middle transition-all bg-transparent border-0 rounded-lg shadow-none cursor-pointer hover:scale-102 leading-pro ease-soft-in tracking-tight-soft bg-150 bg-x-25 active:opacity-85 text-slate-700">
                  <i className="fa fa-close" onClick={handleActive}></i>
                </button>
              </div>
